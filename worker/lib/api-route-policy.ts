...
export const PROJECT_API_KEY_ROUTES: ApiRoutePolicyEntry[] = [
  ...
  { method: "GET", path: "/api/projects/:projectId/custom-css" },
  { method: "PUT", path: "/api/projects/:projectId/custom-css" },
  { method: "DELETE", path: "/api/projects/:projectId/custom-css" },
