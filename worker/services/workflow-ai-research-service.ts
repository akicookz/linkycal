...
function buildStructurePrompt(researchText: string): string {
  return [
    ...
    "Use only what the notes support; if a field is unknown, return null or [].",
    "Do not invent companies, roles, URLs, or tags.",
    "Recommended tags must already appear on the available-tag list from the research brief.",
